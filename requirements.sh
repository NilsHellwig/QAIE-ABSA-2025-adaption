conda create -n qaie python=3.7.13
conda activate qaie
...
pip install pytorch_lightning==0.8.1 numpy==1.21.2 sentencepiece==0.1.96 scikit-learn send2trash pip install spacy==3.5.4 install editdistance==0.6.2
